...
<div class="input-group main-content">
    <div class="admin-content-left col-lg-9">
        ...
        <div class="specs">
            <textarea name="specs" {{ old('specs') }} id="" class="editor1 form-control mb-5" cols="25" rows="20" placeholder="Thông Số Kĩ Thuật"></textarea>
        </div>
        <textarea name="decs" {{ old('decs') }} id="" class="editor2 form-control mb-5" cols="25" rows="20" placeholder="Mô tả"></textarea>
