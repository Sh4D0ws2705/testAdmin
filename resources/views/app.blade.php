...
<head>
    ...
    <link href="{{ asset('front-end/css/admin-css.css') }}" rel="stylesheet">
    <link href="{{ asset('front-end/css/sb-admin-2.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('show.page' ,['page' => 'index']) }}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('show.page' ,['page' => 'index']) }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('show.page' ,['page' => 'productList']) }}">Product List</a>
                        <a class="collapse-item" href="{{ route('show.page' ,['page' => 'addProduct']) }}">Add Prodcuct</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('show.page' ,['page' => 'orderList']) }}">Order List</a>
                    </div>
                </div>
            </li>
        </ul>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('show.page' ,['page' => 'login']) }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('front-end/js/sb-admin-2.js') }}"></script>
